...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    /* 0: default */
    KEYMAP(
    SLEP,VOLU,  GRV, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, BSPC,  HOME,END,   F1,  F2,  F3,  \
    PAUS,VOLD,  TAB, Q,   W,   E,   R,   T,   Y,   U,   I,   O,   P,   LBRC,RBRC,ESC,   INS, DEL,   F4,  F5,  F6,  \
    SLCK,MUTE,  CAPS,A,   S,   D,   F,   G,   H,   J,   K,   L,   SCLN,QUOT,NUHS,ENT,   UP,  DOWN,  F7,  F8,  F9,  \
